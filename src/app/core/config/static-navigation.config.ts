...
export const STATIC_FUNCTIONS_DETAILS: Record<string, IFunctionDetail> = {
    DBS: {
        ...
        Name_Regional: 'ملخص لوحة المعلومات',
        Default_Order: 10,
        URL: '/',
    },
    EntAdm: {
...
export const STATIC_MODULES_DETAILS: IModulesDetails = {
    ...
    SDB: {
        ...
        Name_Regional: 'لوحة معلومات النظام',
        Default_Order: 10,
    ...
    EUA: {
        ModuleID: 13,
        FunctionID: 3,
        Name: 'Facility User Accounts',
        Name_Regional: 'حسابات مستخدمي المنشأة',
        Default_Order: 20,
    ...
    ESM: {
        ModuleID: 93,
        FunctionID: 3,
        Name: 'Facility Storage Management',
